...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(1, "6cb4ddd24cbef3658d2ac6372d46feb0", "8ca5ead6709e7689acce4d3a1ed8515c") {
      @Override
      public void createAllTables(@NonNull final SQLiteConnection connection) {
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `todos` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `done` INTEGER NOT NULL)");
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        SQLite.execSQL(connection, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '6cb4ddd24cbef3658d2ac6372d46feb0')");
      }
      ...
      public RoomOpenDelegate.ValidationResult onValidateSchema(
        ...
        final Map<String, TableInfo.Column> _columnsTodos = new HashMap<String, TableInfo.Column>(3);
        ...
        if (!_infoTodos.equals(_existingTodos)) {
          return new RoomOpenDelegate.ValidationResult(false, "todos(com.example.app_todo.data.TodoEntity).\n"
                  + " Expected:\n" + _infoTodos + "\n"
                  + " Found:\n" + _existingTodos);
        }
